...
export default {
  ...
  assets: {
    ...
    'dashboard/index.html': {size: 47635, hash: 'cfeb25a887dcd0b71bff65d0e4e747ab23fab09c945f5b538e36c0d48ace3768', text: () => import('./assets-chunks/dashboard_index_html.mjs').then(m => m.default)},
