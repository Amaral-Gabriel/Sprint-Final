...
export default {
  ...
  assets: {
    ...
    'dashboard/index.html': {size: 47635, hash: 'cb145ecdd48431250ba5d01939eb3e9a58555dea531179397a9538d49cbf84d5', text: () => import('./assets-chunks/dashboard_index_html.mjs').then(m => m.default)},
