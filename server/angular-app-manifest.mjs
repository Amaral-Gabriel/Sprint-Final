...
export default {
  ...
  assets: {
    ...
    'dashboard/index.html': {size: 47635, hash: 'aa5ab7926ef0db34d3aa0fdf716189c1cc80906c18ee987d5179f37405b0c291', text: () => import('./assets-chunks/dashboard_index_html.mjs').then(m => m.default)},
